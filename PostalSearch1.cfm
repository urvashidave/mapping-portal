...
<body>
<Cfset ds_dataWBOX="1101621_ORCA">
<Cfset ds_userWBOX="hmsservice">
<Cfset ds_passWBOX="Retail@Marketing1">

<Cfset ds_dataGeyser="1101621_Geyser">		
<Cfset ds_UserGeyser="u1101621_johnnyfu">	
<Cfset ds_passGeyser="Td72Waxw">
...
<tr>
<td><center><img src="JYSK.jpg" height=50 width=100 style="margin-bottom:10px"></center></td>
</tr>

<tr bgcolor="skyblue"><td class="BigTitleW" align="center">Postal Code Analysis Report</td></tr></Table>
...
<Cfif isdefined("Form.Show")>
	...
	<Cfset URL.S = "19,31,33"><Cfset SS="JY">	<!--- JYSK --->
...
<cfform name="X" Action="PostalSearch1.cfm?Requesttimeout=900">

<tr><td><Cfinput type="button" class="btn btn-danger" name="back" value="BACK" onClick="javascript:window.history.go(-1);"></td>
<Td width=75></td><td class="Title" align="right">Postal Code: </td>

<td><Cfinput Name=Pcode mask="A9A 9A9" class="Title" value="#PXX#" size="10">&nbsp;<Cfinput class="btn btn-warning" name="Submit" type="submit" value="Go">
...
<Cfcatch type="database">
	...
	<tr><td colspan=7 class="smalltext">DETAILS: #cfcatch.Detail#</td>
...
<!--- New Postal Code Lookup --->
<Cfif Len(PXX) GT 2>
		<CFstoredProc 
			procedure="p_Web_LDU_Analysis_Report"
			datasource="#ds_dataWBOX#" 
			username="#ds_userWBOX#" 
			password="#ds_passWBOX#">
		<cfprocparam 
		...
		<cfprocparam 
			Value="#PXX#" 
			cfsqltype="cf_sql_varchar">
    	<cfprocresult name="PX">
		</CFstoredProc>
<Table width=806 class="databox" align="center" cellpadding=0 cellspacing=0>
	<Tr><td colspan=12 Class="BigTitle">Postal Code Analysis</td></Tr>
	<tr bgcolor="skyblue" bordercolor="skyblue" bordercolordark="skyblue" >
		<td colspan="4">&nbsp;</td><td class="textw" align="center" colspan=3>Deliver</td>
	<Tr bgcolor="skyblue" bordercolor="skyblue" bordercolordark="skyblue">
	<Tr bgcolor="skyblue" bordercolor="skyblue" bordercolordark="skyblue">
	    
		<td class="textw" width=250>&nbsp;Postal Code</td>
		
		<td class="textw" align="right" width=100>Sales</td>
...
<tr><td class="text">#PX.FSALDU#</td>
	<td class="text" align="right">#DollarFormat(PX.LDU_Sales)#</td>
	<td class="text" align="right">#DollarFormat(PX.LDU_Sales_HHLD_Week)#</td>
	<td class="text" align="center">#PX.Version#</td>
	<td class="text" align="center">#PX.A_QTY#</td>
	<td class="text" align="center">#PX.B_QTY#</td>
	<td class="text" align="center">#PX.C_QTY#</td></TR>
</Table>
</cfif>
...
<Table width=806 class="databox" align="center" cellpadding=0 cellspacing=0>
	<Tr><td colspan=12 Class="BigTitle">Route Analysis</td></Tr>
	<tr bgcolor="skyblue" bordercolor="skyblue" bordercolordark="skyblue" >
		<td colspan="4">&nbsp;</td><td class="textw" align="center" colspan=3>Deliver</td>
	<Tr bgcolor="skyblue" bordercolor="skyblue" bordercolordark="skyblue"><!---td class="smalltext" align="center">Store</td>
	    <td class="smalltextw">Distributor</td--->
		<td class="textw" width=250>&nbsp;Route</td>
...
<center><cfform name="CX" action="PostalSearch1.cfm">
	<Cfinput type="hidden" name="Pcode" value="#form.Pcode#">
	<Cfinput type="hidden" name="Show" value="1">
	
	<Cfinput type="submit" class="btn btn-warning" name="submit" value="Show Competition">
</cfform>
</cfif>
</center>
